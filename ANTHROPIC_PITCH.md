...
- **80+ sources** including major world museums (Met, V&A, Rijksmuseum, Getty, Tate, Smithsonian network), nature archives (iNaturalist, GBIF, NASA, NOAA), cultural heritage institutions (Library of Congress, Gallica, Internet Archive), and open photography
...
InspoSearch was built in a series of focused sessions using Claude in VS Code Copilot. The entire application — 11,000+ lines of HTML/CSS/JS, 80+ API integrations, a multi-provider AI layer, a canvas snapshot pipeline — is a single file that opens in a browser by double-click.
